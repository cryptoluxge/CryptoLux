...
const DepositButton = ({ name, poolContract }) => {
  ...
  const withdrawFromPool = async () => {
    ...
    if (Number(stakeValue) > Number(userBalance)) {
      console.log('მეტს ვერ გამოიტანეთ')
    } else {
  ...
  const data = async () => {
    ...
    console.log(getData.userStaked)
                    ...
                    <div className='p-3'>
                      <div>
                        ...
                        <div className='flex items-center gap-2'>
                          <input type="text" id="cakeToWithdraw" className="rounded-lg block w-full p-2.5 bg-gray-200 dark:bg-darkCard dark:border-primary dark:placeholder-gray-400 text-lightText dark:text-white" placeholder="CAKE რაოდენობა" required />
                      ...
                      <div className='flex justify-between items-center mt-3'>
                        <p className="block mb-2 text-sm font-medium text-lightText dark:text-darkText">დასტეიკებული გაქვთ:</p>
