...
const ChainSelector = () => {
	...
	return (
		<Menu as="div" className="inline-block text-left">
			<Menu.Button className="px-2 py-2.5 flex items-center justify-center w-full rounded-md bg-gradient-to-br from-violet to-violetDark text-sm font-medium text-white duration-150 hover:bg-dark">
				<div className='flex items-center gap-2'>
					<p className='text-white font-semibold'>{getChainName(chainId)}</p>
				</div>
